    ...
    public boolean onStartGame(View view) {
        ...
        while(counter1 < word1.length() || counter2 < word2.length()) {
            ...
            if(counter1 < word1.length() && counter2 < word2.length()) {
                option = random.nextInt(2) + 1; // 1 or 2
            } else if(counter1 >= word1.length()) {
                option = 2;
            } else {
                option = 1;
            }

            shuffledWord.append(option == 1 ? word1.charAt(counter1) : word2.charAt(counter2));
        ...
        // Stacked layout
        for(char c : shuffledWord.reverse().toString().toCharArray()) {
